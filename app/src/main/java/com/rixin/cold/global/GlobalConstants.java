...
public class GlobalConstants {
    ...
    public final static String SERVICE_URL = "http://www.lzs100.cc/";  // 首页
     ...
     *  搜索
     */
    public final static String SOCKET = "?q=";
    public final static String SEARCH_SERVICE_URL = "http://www.lzs100.cc/search.php";

    /**
     * 每日一冷
     */
    public final static String EVERYDAY_CACHE_KEY = "EverydayCache";  // 缓存key
    public final static String EVERYDAY_CURRENT_URL_KEY = "everydayUrl";   // 下一篇key
    public final static String EVERYDAY_SERVICE_URL = "http://www.lzs100.cc/post/3.html";
    ...
    public final static String TABS_ENCYCLOPEDIA_NEXT_URL = TABS_ENCYCLOPEDIA_URL + "/";  // 百科下一页
    ...
    public final static String TABS_ANIMAL_NEXT_URL = TABS_ANIMAL_URL + "/";  // 动物下一页
    ...
    public final static String TABS_ASTRONOMY_NEXT_URL = TABS_ASTRONOMY_URL + "/";  // 天文下一页
    ...
    public final static String TABS_CULTURE_NEXT_URL = TABS_CULTURE_URL + "/";  // 文化下一页

    public final static String TABS_BODY_CACHE_KAY = "rentiCache";
    public final static String TABS_BODY_URL = SERVICE_URL + "renti";  // 人体
    public final static String TABS_BODY_NEXT_URL = TABS_BODY_URL + "/";  // 人体下一页
    ...
    public final static String TABS_HISTORY_NEXT_URL = TABS_HISTORY_URL + "/";  // 历史下一页
    ...
    public final static String TABS_GEOGRAPHY_NEXT_URL = TABS_GEOGRAPHY_URL + "/";  // 地理下一页
    ...
    public final static String TABS_NATURE_NEXT_URL = TABS_NATURE_URL + "/";  // 自然下一页
    ...
    public final static String TABS_LIFE_NEXT_URL = TABS_LIFE_URL + "/";  // 生活下一页
    ...
    public final static String TABS_SCIENCE_NEXT_URL = TABS_SCIENCE_URL + "/";  // 科学下一页
    ...
    public final static String TABS_PHYSICAL_NEXT_URL = TABS_PHYSICAL_URL + "/";  // 体育下一页

    public final static String TABS_PLANT_CACHE_KAY = "zhiwuCache";
    public final static String TABS_PLANT_URL = SERVICE_URL + "zhiwu";  // 植物
    public final static String TABS_PLANT_NEXT_URL = TABS_PLANT_URL + "/";  // 植物下一页
    ...
    public final static String TABS_CELEBRITY_NEXT_URL = TABS_CELEBRITY_URL + "/";  // 名人下一页
